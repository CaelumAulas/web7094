<!-- https://github.com/CaelumAulas/web7094 -->
...
<html>
  ...
  <body>
    ...
    <figure id="centro-distribuicao">
      ...
      <figcaption style="font-style: italic; font-weight: oblique;">Centro de distribuição da Mirror Fashion</figcaption>
    </figure>
    ...
    <ul>
      ...
      <li>Atendimento via telefone, email, chat, twitter,</li> facebook, carta, fax e telegrama
      ...
      <li>Atendimento via telefone, email, chat, twitter,</li> facebook, carta, fax e telegrama
      <li>Presente em 124 países</li>
      <li>Mais de um milhão de funcionários em todo o mundo</li><li>Menor preço do varejo, garantido</li>
      <li>Se você achar uma loja mais barata, leva o produto de graça</li>
      <li>Pague em reais, dólares, euros ou bitcoins</li>
      <li>Todas as compras com frete grátis para o mundo todo</li>
      <li>Maior comércio eletrônico de moda do mundo</li>
